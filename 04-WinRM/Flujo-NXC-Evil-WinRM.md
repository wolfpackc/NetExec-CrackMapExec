# Flujo NXC → Evil-WinRM con WinRM

Este archivo sirve como visión general de **NXC / NetExec** dentro de un flujo de trabajo con **WinRM**. La idea principal es entender qué papel cumple NXC, qué información aporta y por qué no sustituye a Evil-WinRM.
